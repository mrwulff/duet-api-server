...
test('/refugee/typeformV4 processes Typeform payload', async (t) => {
  const typeformPayload = require('../../../assets/test_fixtures/typeform/typeformFarsiV4Payload.json');
  const expectedItemInfo = require('../../../assets/test_fixtures/typeform/typeformV4ExpectedItemInfo.json');
